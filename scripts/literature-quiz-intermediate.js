...
document.addEventListener('DOMContentLoaded', function() {
    const quizData = [
        ...
        {
            "question": "What is the name of the protagonist in George Orwell's novel '1984'?",
        ...
        {
            "question": "What is the name of the dragon in J.R.R. Tolkien's novel 'The Hobbit'?",
            "answers": ["Smaug", "Drogon", "Falkor", "Glaurung"],
            "correct": "Smaug"
        },
        {
            "question": "Who authored the novel 'The Great Gatsby'?",
